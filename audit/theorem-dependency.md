...
flowchart TD
  ...
  L110 --> C115
  L113 --> C115
  L42 --> L116["L116 quotient erasure"]
...
26. **Theorem 118 fixes a scale but does not close the pure-upper branch.**
    An all-unit pure-upper tail would have adjacent gaps whose sum is
    logarithmic and block starts of order \(J\log J\). The quotient ratio
...
| 36 | Local L98 identities and C95 -> L100, then C97, L100, and T99 -> T101 -> C102 | Three-start indexing, equality of only the first two block lengths, power-of-two divisibility for decreasing gaps, both zero-gap exceptional cases, strict-growth versus bounded-mean contradiction, and exact surviving gate alternatives |
