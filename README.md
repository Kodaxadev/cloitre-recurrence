...
| Nonunique gates have exact finite multiplicity | New internal proof | Lemma 110 and Corollary 111 count every lower and upper lattice translate from the canonical-window index and the two parent/child headrooms; displacement alone can be truncated and is not yet a contradiction |
