...
| Unit-wrap gates have an exact boundary test | New internal proof | Lemmas 85/87 and Corollaries 86/88/89 give an affine map on \((n,D,s)\), characterize uniqueness by two boundary layers, force one logarithmic gap every three gates, and confine an infinite all-unique unit-wrap chain to \(1\le\liminf U\log_2n/n\le\limsup U\log_2n/n\le3\); this is not termination |
