...
| **C146** | An infinite chain has $G_i\to\infty$, and either $k_i=1$ for all large $i$, or $G_i\ge2i+11$ infinitely often; so such a chain is eventually all-unit — the fibre T130 already treats as a three-integer map — or its budget grows at least linearly | `admissible-budget.md` | **Corollary - new; immediate from T145 and C144; external review pending; a dichotomy, not an exclusion of either branch** |
