...
| **L94** | Every arbitrary adjacent-block gate obeys an exact affine equation in $(n,U)$; two fixed consecutive parameter tuples determine at most one rational start unless their explicit determinant vanishes | `parent-boundary-gate-analysis.md` | **Lemma - new; fresh audit pending; parameter reduction, not a uniform bound** |
