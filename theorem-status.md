...
| **T58** | In every sublinear counterexample, down-steps have zero density in time and among quotient changes, while $q_n/C(n)\to1$ | `sparse-downstep-analysis.md` | **Theorem - new; fresh audit pending** |
