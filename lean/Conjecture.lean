...
The block-chain length bound and its supporting arithmetic live on the
`research/admissible-budget` branch, not here. This branch carries the paper and
the chain the paper cites.
-/
